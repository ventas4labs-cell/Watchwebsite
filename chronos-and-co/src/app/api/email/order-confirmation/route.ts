...
// Only initialize if the key exists to prevent crashing the server immediately
...
export async function POST(req: Request) {
    ...
    try {
                                ...
                                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background-color: #111111; border: 1px solid #333333; border-radius: 4px;">
                                    ...
                                    <tr>
                                        <td align="center" style="padding: 40px 0 20px 0; border-bottom: 1px solid #333333;">
                                            <h1 style="color: #D4AF37; margin: 0; font-size: 24px; letter-spacing: 4px; text-transform: uppercase;">Chronos & Co.</h1>
                                    ...
                                    <tr>
                                        <td style="padding: 40px 40px;">
                                            ...
                                            <p style="color: #cccccc; font-size: 14px; line-height: 1.6;">Gracias por confiar en Chronos & Co. Hemos recibido su pedido exitosamente y nuestro equipo ya está trabajando para asegurar su pieza.</p>
                                    ...
                                    <tr>
                                        <td align="center" style="padding: 30px 40px; background-color: #0a0a0a; border-top: 1px solid #333333;">
                                            <p style="color: #666666; font-size: 10px; line-height: 1.5; margin: 0;">Este es un mensaje automático generado por Chronos & Co.<br/>Para asistencia personalizada, responda a este correo o contacte a su asesor asignado.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        const data = await resend.emails.send({
            from: 'Chronos & Co. <orders@updates.4labs.pro>',
            to: [email],
